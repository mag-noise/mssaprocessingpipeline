# MSSAProcessingPipeline

Using MSSA to process signals for noise removal.
...
```
cd existing_repo
git remote add origin https://research-git.uiowa.edu/klsteele/mssaprocessingpipeline.git
git branch -M main
...
- [ ] [Set up project integrations](https://research-git.uiowa.edu/klsteele/mssaprocessingpipeline/-/settings/integrations)
...
## Requirements
 ...
 - CMake (3.15 minimum [Download](https://cmake.org/download/))
	- Ninja-build comes with CMake, but if needed:
...
## Installation
 - cmake -B build -S . -DCMAKE_TOOLCHAIN_FILE=%VCPKG_ROOT%\scripts\buildsystems\vcpkg.cmake
  - if any issues installing packages, run: "%VCPKG_ROOT%\vcpkg install"
 - matlab: %vcpkg_root%
 - matlab: mex -setup
